<?php 
require 'PHP/simplepie.inc'; // for RSS feeds
require 'PHP/obfuscate.php'; // for javascripting my phone number and email
require 'PHP/age.php'; //age() and time_since()
require "PHP/v4.generics.php"; // get_iphone(), twitter parser.
?>
