      ...
      >
        ...
        >
          <g>
            ...
            <path
              class="st0"
              d="M310,310V206.7h-51.7h-51.7C206.7,263.7,253,310,310,310z"
            />
            <path
              class="st0"
              d="M310,0c-57,0-103.3,46.3-103.3,103.3h51.7H310V0z"
            />
            <path
              class="st0"
              d="M0,206.7V310c57,0,103.3-46.3,103.3-103.3H51.7H0z"
            />
            <path
              class="st0"
              d="M103.3,206.7V310c18.8,0,36.5-5,51.7-13.8c15.2,8.8,32.9,13.8,51.7,13.8V206.7H155H103.3z"
            />
            <path
              class="st0"
              d="M206.7,103.3V0c-18.8,0-36.5,5-51.7,13.8C139.8,5,122.1,0,103.3,0v103.3H155H206.7z"
            />
          </g>
        </svg>
      </a>
