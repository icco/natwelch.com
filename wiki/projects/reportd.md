...
You send reports to `reportd.natwelch.com/reports/$servicename` for security issues and `/analytics/$servicename` for web vitals. The code lives at [github.com/icco/reportd](https://github.com/icco/reportd). The whole thing is designed to be a lightweight receiver—no fancy dashboards or complex analytics, just a reliable endpoint that captures what your browsers are reporting.
