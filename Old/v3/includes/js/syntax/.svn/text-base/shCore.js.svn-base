	...
	CopyToClipboard: {
		...
		func: function(sender, highlighter)
		{
			...
			else if(dp.sh.ClipboardSwf != null)
			{
				...
				flashcopier.innerHTML = '<embed src="../../../js/syntax/' + dp.sh.ClipboardSwf + '" FlashVars="clipboard='+encodeURIComponent(code)+'" width="0" height="0" type="application/x-shockwave-flash"></embed>';
			}
...
dp.sh.Utils.CopyStyles = function(destDoc, sourceDoc)
{
	...
	for(var i = 0; i < links.length; i++)
		if(links[i].rel.toLowerCase() == 'stylesheet')
			destDoc.write('<link type="text/css" rel="stylesheet" href="../../../js/syntax/' + links[i].href + '"></link>');
}
