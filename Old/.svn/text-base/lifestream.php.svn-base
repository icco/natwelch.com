...
<div class="all">
		<div class="quote">
			<div class="header"><a href="http://natwelch.com" title="About Me">Home</a> | <a href="../code/index.php">Projects</a> | <a href="http://pseudoweb.net"  >Blog</a> | <a href="http://flickr.com/photos/icco" title="Photos"  >Photos</a> | <a href="../resume.pdf" title="Resume in PDF form"   onclick="javascript:urchinTracker ('/resume')">Resume<font size="-4">(PDF)</font></a> </p>
		</div>
